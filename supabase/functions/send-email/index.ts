...
const DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        subject: 'Pagamento Confirmado - {{plan_name}}',
        html: `<div style="font-family: sans-serif; padding: 40px; background: #f8fafc;"><div style="max-width: 600px; margin: 0 auto; bg-color: #fff; padding: 40px; border-radius: 20px; border: 1px solid #e2e8f0;"><div style="text-align: center; margin-bottom: 30px;"><span style="font-size: 48px; color: #10b981;">feat</span></div><h1 style="color: #1e293b; margin-top: 0; text-align: center;">Pagamento Confirmado!</h1><p style="color: #64748b; line-height: 1.6; text-align: center;">Olá, <strong>{{full_name}}</strong>.</p><p style="color: #64748b; line-height: 1.6; text-align: center;">Recebemos a confirmação do seu pagamento referente ao plano <strong>{{plan_name}}</strong>.</p><div style="background: #f1f5f9; padding: 20px; border-radius: 12px; margin: 30px 0; text-align: center;"><p style="margin: 0; font-size: 12px; color: #64748b; text-transform: uppercase; font-weight: bold;">Valor Pago</p><p style="margin: 5px 0 0; font-size: 24px; color: #0f172a; font-weight: bold;">R$ {{amount}}</p><p style="margin: 10px 0 0; font-size: 12px; color: #94a3b8;">{{date}}</p></div><p style="color: #64748b; font-size: 14px; text-align: center;">Sua assinatura já está ativa e você pode aproveitar todos os benefícios agora mesmo.</p><div style="text-align: center; margin: 40px 0;"><a href="https://www.vaivistoriar.com.br/pj" style="display: inline-block; background: #2563eb; color: #fff; padding: 16px 32px; border-radius: 12px; text-decoration: none; font-weight: bold; font-size: 16px;">Acessar Painel</a></div></div></div>`
    }
];
