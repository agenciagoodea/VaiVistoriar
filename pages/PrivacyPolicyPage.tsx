            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="bg-white rounded-[40px] border border-slate-100 shadow-xl p-12 space-y-8">
                    <div className="border-b border-slate-100 pb-8">
                        <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Política de Privacidade</h1>
                    ...
                    <div className="prose prose-slate max-w-none">
                        {content ? (
                            ...
                            <div className="text-center py-20 text-slate-400">
                                <p className="font-bold">Política de Privacidade não configurada.</p>
