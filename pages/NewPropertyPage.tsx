...
const NewPropertyPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Encontrar nome do proprietário para compatibilidade se necessário
                ...
                .insert([
                    {
                        ...
                        description,
                        image_url: facadeUrl || (type === 'Apartamento' ? 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=400' : 'https://images.unsplash.com/photo-1518780664697-55e3ad937233?auto=format&fit=crop&q=80&w=400')
                    }
                ]);
            ...
            setError(err.message || 'Erro ao processar cadastro do imóvel.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight">Cadastrar Imóvel</h1>
                    <p className="text-slate-500 mt-1">Insira as informações técnicas para o laudo de vistoria.</p>
                </div>
                <button
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="md:col-span-2 grid md:grid-cols-2 gap-x-8 gap-y-6">
                            <div className="space-y-1.5 md:col-span-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Vincular Proprietário (Cliente)</label>
                                <select
                                    value={ownerId}
                                ...
                                <p className="text-[9px] text-slate-400 ml-1 italic">* Caso não encontre, cadastre o proprietário no menu Clientes primeiro.</p>
                            </div>
                            ...
                            <div className="space-y-1.5 md:col-span-1">
                                ...
                                <input
                                    ...
                                    placeholder="Número do IPTU oue matrícula"
                                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-sm focus:ring-2 focus:ring-blue-500/10 transition-all outline-none"
                                />
                            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 pt-4">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="w-full h-48 rounded-3xl overflow-hidden border border-slate-100 bg-slate-50 relative shadow-inner group">
                                {street.length > 5 ? (
                                    <iframe
                                        width="100%"
                                        height="100%"
                                    ...
                                    <div className="flex flex-col items-center justify-center h-full text-slate-300">
                                        ...
                                        <p className="text-[9px] font-black uppercase mt-2">Aguardando endereço para exibir o mapa</p>
                                    </div>
                                )}
                            </div>
